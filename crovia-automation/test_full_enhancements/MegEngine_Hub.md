...
git clone https://github.com/MegEngine/Hub
...
```bibtex
@misc{MegEngine_Hub_2026,
  author = {MegEngine},
  title = {MegEngine/Hub},
  year = {2026},
  url = {https://github.com/MegEngine/Hub},
...
*Enhancement generated by [CROVIA](https://croviatrust.com) · Package ID: `cc575a8b22c1`*
