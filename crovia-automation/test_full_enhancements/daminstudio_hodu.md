...
git clone https://github.com/daminstudio/hodu
...
```bibtex
@misc{daminstudio_hodu_2026,
  author = {daminstudio},
  title = {daminstudio/hodu},
  year = {2026},
  url = {https://github.com/daminstudio/hodu},
...
*Enhancement generated by [CROVIA](https://croviatrust.com) · Package ID: `5720124fda3e`*
